...
| `lhb-industry-compare <code> --start-date YYYY-MM-DD --end-date YYYY-MM-DD` | A股同申万行业龙虎榜辨识度对比；先用理杏仁 `cn/industry/constituents` 找锚定股票所属行业成分，锚定代码排第一，再取最多 `--max-codes` 个代码复用 `lhb-compare`；适合同板块/主题快速横向辨识，`source_detail: lixinger+legacy:lhb-industry-compare` | `lhb-industry-compare 600519 --start-date 2026-06-01 --end-date 2026-06-26 --max-codes 4` |

...
| 文件 | 行号 | 问题 |
|---|---:|---|
| `skills/news-pulse.md` | 78, 92, 106, 119, 154 | 多处要求先执行 `mx-search`，但未明确要求输出/报告标注 `_source: mx-search` |
| `codex/ai-berkshire/references/skills/news-pulse.md` | 78, 92, 106, 119, 154 | Codex 副本同步了同一缺口 |

...
将完整报告写入 `reports/{公司名}/{公司名}-checklist-{YYYYMMDD}.md`；多公司 Checklist 写入 `reports/多公司对比-checklist-{YYYYMMDD}.md`
